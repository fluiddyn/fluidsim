"""Script for a test of the method :meth:`fluidsim.operators.operators3d.OperatorsPseudoSpectral3D.project_kradial3d`, :meth:`fluidsim.operators.operators3d.OperatorsPseudoSpectral3D.project_kpolo3d` and :meth:`fluidsim.operators.operators3d.OperatorsPseudoSpectral3D.project_ktoro3d` projections implemented in operators3d.py
...
E_pa = op.compute_energy_from_3fields(vx_fft_pt, vy_fft_pt, vz_fft_pt)
assert (
...
E_tk = op.compute_energy_from_3fields(vx_fft_tk, vy_fft_tk, vz_fft_tk)
assert np.max(
    E_pk / E_v < 1e-14
