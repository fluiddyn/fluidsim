...
conda create -n env_fluidsim \
    ipython python=3.10 scipy "blas-devel[build=*openblas]" \
...
pip install mpi4py --no-binary mpi4py --use-feature=no-binary-enable-wheel-cache
...
HDF5_DIR=/gpfslocalsup/spack_soft/hdf5/1.12.0/gcc-8.3.1-qj43pa5rathksrgn4sx2ici42tg75nun
CC="mpicc" HDF5_MPI="ON" HDF5_DIR=/gpfslocalsup/spack_soft/hdf5/1.12.0/gcc-8.3.1-qj43pa5rathksrgn4sx2ici42tg75nun pip install --no-deps --use-feature=no-binary-enable-wheel-cache --force-reinstall h5py
