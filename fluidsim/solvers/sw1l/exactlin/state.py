...
class StateSW1LExactLin(StateSW1L):
    ...
    def _complete_info_solver(info_solver):
        ...
        info_solver.classes.State._set_attribs(
            {
                "keys_state_spect": ["ap_fft", "am_fft", "q_fft"],
    ...
    def statespect_from_statephys(self):
        ...
        self.state_spect.set_var("q_fft", q_fft)
    ...
    def init_from_uxuyetafft(self, ux_fft, uy_fft, eta_fft):
        ...
        state_spect = self.state_spect
        state_spect.set_var("q_fft", q_fft)
