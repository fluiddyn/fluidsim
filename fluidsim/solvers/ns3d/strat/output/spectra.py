...
class SpectraNS3DStrat(SpectraNS3D):
    ...
    def compute(self):
        ...
        dict_spectra1d = {
            'vx_kx': s_vx_kx, 'vx_ky': s_vx_ky, 'vx_kz': s_vx_kz,
            'vy_kx': s_vy_kx, 'vy_ky': s_vy_ky, 'vy_kz': s_vy_kz,
            'vz_kx': s_vz_kx, 'vz_ky': s_vz_ky, 'vz_kz': s_vz_kz,
            'E_kx': s_kx, 'E_ky': s_ky, 'E_kz': s_kz,
            'A_kx': s_A_kx, 'A_ky': s_A_ky, 'A_kz': s_A_kz,
            'Khr_kx': s_Khr_kx, 'Khr_ky': s_Khr_ky, 'Khr_kz': s_Khr_kz,
            'Khd_kx': s_Khd_kx, 'Khd_ky': s_Khd_ky, 'Khd_kz': s_Khd_kz,
        }
