...
namespace __pythran__pythran_pseudo_spect
{
  ...
  struct rk4_step0
  {
    ...
    struct type
    {
      ...
      typedef __type8 __ptype4;
      typedef __type10 __ptype5;
      typedef typename pythonic::returnable<pythonic::types::none_type>::type result_type;
    }  
    ;
    template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 , typename argument_type5 , typename argument_type6 >
  ...
  {
    {
      static typename arguments_blocks::type::result_type tmp_global = typename pythonic::assignable<pythonic::types::dict<pythonic::types::str,pythonic::types::list<typename std::remove_reference<pythonic::types::str>::type>>>::type{{{ "rk2_step0", typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename __combined<typename __combined<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype("state_spect")>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("tendencies_n")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss2")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("dt")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_n12")>::type>::type>::type>::type>>::type({"state_spect_n12", "state_spect", "tendencies_n", "diss2", "dt"}) }, { "rk2_step1", typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename __combined<typename __combined<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype("state_spect")>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("tendencies_n12")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss2")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("dt")>::type>::type>::type>::type>>::type({"state_spect", "tendencies_n12", "diss", "diss2", "dt"}) }, { "rk4_step0", typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename __combined<typename __combined<typename __combined<typename __combined<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype("state_spect")>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss2")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_tmp")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("dt")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("tendencies_0")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_np12_approx1")>::type>::type>::type>::type>>::type({"state_spect", "state_spect_tmp", "tendencies_0", "state_spect_np12_approx1", "diss", "diss2", "dt"}) }, { "rk4_step1", typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename __combined<typename __combined<typename __combined<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype("state_spect")>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss2")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_tmp")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("dt")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_np12_approx2")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("tendencies_1")>::type>::type>::type>::type>>::type({"state_spect", "state_spect_tmp", "state_spect_np12_approx2", "tendencies_1", "diss2", "dt"}) }, { "rk4_step2", typename pythonic::assignable<pythonic::types::list<typename std::remove_reference<typename __combined<typename __combined<typename __combined<typename __combined<typename __combined<typename __combined<typename std::remove_cv<typename std::remove_reference<decltype("state_spect")>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("diss2")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_tmp")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("dt")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("state_spect_np1_approx")>::type>::type>::type,typename std::remove_cv<typename std::remove_reference<decltype("tendencies_2")>::type>::type>::type>::type>>::type({"state_spect", "state_spect_tmp", "state_spect_np1_approx", "tendencies_2", "diss", "diss2", "dt"}) }}};
      return tmp_global;
    }
  }
  template <typename argument_type0 , typename argument_type1 , typename argument_type2 , typename argument_type3 , typename argument_type4 , typename argument_type5 , typename argument_type6 >
...
static PyObject* arguments_blocks = to_python(__pythran__pythran_pseudo_spect::arguments_blocks()());
typename __pythran__pythran_pseudo_spect::rk4_step2::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, pythonic::types::ndarray<double,2>, double>::result_type rk4_step20(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np1_approx, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_2, pythonic::types::ndarray<double,2>&& diss, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran__pythran_pseudo_spect::rk4_step2()(state_spect, state_spect_tmp, state_spect_np1_approx, tendencies_2, diss, diss2, dt);
...
typename __pythran__pythran_pseudo_spect::rk4_step2::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk4_step21(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np1_approx, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_2, pythonic::types::ndarray<double,2>&& diss, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk4_step2::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, pythonic::types::ndarray<double,2>, double>::result_type rk4_step22(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np1_approx, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_2, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk4_step2::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk4_step23(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np1_approx, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_2, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk4_step1::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, double>::result_type rk4_step10(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np12_approx2, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_1, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran__pythran_pseudo_spect::rk4_step1()(state_spect, state_spect_tmp, state_spect_np12_approx2, tendencies_1, diss2, dt);
                                PyEval_RestoreThread(_save);
                                return res;
                            }
                            catch(...) {
...
typename __pythran__pythran_pseudo_spect::rk4_step1::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk4_step11(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np12_approx2, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_1, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk4_step0::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, pythonic::types::ndarray<double,2>, double>::result_type rk4_step00(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_0, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np12_approx1, pythonic::types::ndarray<double,2>&& diss, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran__pythran_pseudo_spect::rk4_step0()(state_spect, state_spect_tmp, tendencies_0, state_spect_np12_approx1, diss, diss2, dt);
                                PyEval_RestoreThread(_save);
                                return res;
                            }
                            catch(...) {
...
typename __pythran__pythran_pseudo_spect::rk4_step0::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk4_step01(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_0, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np12_approx1, pythonic::types::ndarray<double,2>&& diss, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk4_step0::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, pythonic::types::ndarray<double,2>, double>::result_type rk4_step02(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_0, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np12_approx1, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk4_step0::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk4_step03(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_tmp, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_0, pythonic::types::ndarray<std::complex<double>,3>&& state_spect_np12_approx1, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk2_step1::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, pythonic::types::ndarray<double,2>, double>::result_type rk2_step10(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_n12, pythonic::types::ndarray<double,2>&& diss, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran__pythran_pseudo_spect::rk2_step1()(state_spect, tendencies_n12, diss, diss2, dt);
                                PyEval_RestoreThread(_save);
                                return res;
                            }
                            catch(...) {
...
typename __pythran__pythran_pseudo_spect::rk2_step1::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk2_step11(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_n12, pythonic::types::ndarray<double,2>&& diss, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk2_step1::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, pythonic::types::ndarray<double,2>, double>::result_type rk2_step12(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_n12, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk2_step1::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk2_step13(pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_n12, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
typename __pythran__pythran_pseudo_spect::rk2_step0::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<double,2>, double>::result_type rk2_step00(pythonic::types::ndarray<std::complex<double>,3>&& state_spect_n12, pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_n, pythonic::types::ndarray<double,2>&& diss2, double&& dt) 
{
  
                            PyThreadState *_save = PyEval_SaveThread();
                            try {
                                auto res = __pythran__pythran_pseudo_spect::rk2_step0()(state_spect_n12, state_spect, tendencies_n, diss2, dt);
                                PyEval_RestoreThread(_save);
                                return res;
                            }
                            catch(...) {
...
typename __pythran__pythran_pseudo_spect::rk2_step0::type<pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::ndarray<std::complex<double>,3>, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>, double>::result_type rk2_step01(pythonic::types::ndarray<std::complex<double>,3>&& state_spect_n12, pythonic::types::ndarray<std::complex<double>,3>&& state_spect, pythonic::types::ndarray<std::complex<double>,3>&& tendencies_n, pythonic::types::numpy_texpr<pythonic::types::ndarray<double,2>>&& diss2, double&& dt) 
{
...
__pythran_wrap_rk4_step00(PyObject *self, PyObject *args, PyObject *kw)
{
    ...
    if(! PyArg_ParseTupleAndKeywords(args, kw, "OOOOOOO",
        ...
        return nullptr;
    if(is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[0]) && is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[1]) && is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[2]) && is_convertible<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[3]) && is_convertible<pythonic::types::ndarray<double,2>>(args_obj[4]) && is_convertible<pythonic::types::ndarray<double,2>>(args_obj[5]) && is_convertible<double>(args_obj[6]))
        return to_python(rk4_step00(from_python<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[0]), from_python<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[1]), from_python<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[2]), from_python<pythonic::types::ndarray<std::complex<double>,3>>(args_obj[3]), from_python<pythonic::types::ndarray<double,2>>(args_obj[4]), from_python<pythonic::types::ndarray<double,2>>(args_obj[5]), from_python<double>(args_obj[6])));
    else {
        return nullptr;
    }
}
...
#endif
PyMODINIT_FUNC
PYTHRAN_MODULE_INIT(_pythran_pseudo_spect)(void)
#ifndef _WIN32
...
PYTHRAN_MODULE_INIT(_pythran_pseudo_spect)(void) {
    ...
    #else
    PyObject* theModule = Py_InitModule3("_pythran_pseudo_spect",
                                         Methods,
                                         ""
    );
    #endif
    ...
    PyObject * theDoc = Py_BuildValue("(sss)",
                                      "0.8.6",
                                      "2018-10-08 14:23:52.208402",
                                      "6733ba9f348edf49840f890fe06900c80e3e2fdad12c3f36f9289fb4a2912919");
    if(! theDoc)
        PYTHRAN_RETURN;
