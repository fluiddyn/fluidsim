...
# pythran export rk2_step0(complex128[][][], complex128[][][], complex128[][][], complex128[][][], float)
...
# pythran export rk2_step1(complex128[][][], complex128[][][], complex128[][][], complex128[][][], float)
...
# pythran export rk4_step0(complex128[][][], complex128[][][], complex128[][][], complex128[][][], complex128[][][], complex128[][][], float)
...
# pythran export rk4_step1(complex128[][][], complex128[][][], complex128[][][], complex128[][][], complex128[][][], float)
...
# pythran export rk4_step2(complex128[][][], complex128[][][], complex128[][][], complex128[][][], complex128[][][], complex128[][][], float)
...
# pythran export rk4_step3(complex128[][][], complex128[][][], complex128[][][], float)
...
arguments_blocks = {
    ...
    "rk4_step3": ["state_spect", "state_spect_tmp", "tendencies_3", "dt"],
}
