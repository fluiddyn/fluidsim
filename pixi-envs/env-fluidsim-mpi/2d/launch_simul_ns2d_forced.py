"""Script for a short simulation with the solver ns2d
...
params.output.sub_directory = "tma"
...
params.oper.coef_dealiasing = 0.665

params.nu_8 = 1e-9

params.time_stepping.t_end = 10.0
params.time_stepping.cfl_coef = 0.2
params.time_stepping.max_elapsed = "00:00:20"
...
if mpi.rank == 0:
    ...
    print(f"P_tot corrects when forcing in {key_forced} (neg_enable = {neg_enable})")
