...
params.oper.Lx = Lh = 2.0*pi
params.oper.Ly = 2.0*pi * params.oper.ny / params.oper.nx
params.oper.Lz = 2.0*pi 
...
params.init_fields.noise.velo_max = 1.0 #1e-2
...
order = 2
params.nu_2 = 0.025 #0.025 
mpi.printby0(f"{params.nu_2 = :.2e}")

params.output.periods_print.print_stdout = 1.0
params.output.periods_save.phys_fields = 30.0
params.output.periods_save.spatial_means = 0.1
params.output.periods_save.spectra = 10
params.output.periods_save.spect_energy_budg = 600
params.output.periods_save.horiz_means = 10
