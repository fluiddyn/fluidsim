"""
plot_buoyancy_reynolds_anisotropy.py
=====================================
...
# Plot...
for _r, _a, _d, _m in zip(reynoldsb, anisotropies, dissipations, markers):
    scatter = ax.scatter(_r, _a, s=100, c=_d, vmin=0, vmax=1, marker=_m)
...
if SAVE:
    path_save = (
        ...
        + "buoyancy_reynolds_anisotropy.png"
    )
