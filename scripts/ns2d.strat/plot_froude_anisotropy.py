...
# Plot...
for _f, _a, _d, _m in zip(froudes, anisotropies, dissipations, markers):
    scatter = ax.scatter(_f, _a, s=100, c=_d, vmin=0, vmax=1, marker=_m)
...
ax.text(1.1, 0.013, r"$\log_{10} \left(\frac{k_{x, 1/2}}{k_{x, f}}\right)$", fontsize=12)
