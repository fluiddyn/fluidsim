...
limit_maxmin(Us_over_c, 0., 2.)

sim.output.phys_fields.plot(field=Us_over_c, key_field='Us/c', 
                            nb_contours=20)
...
sim.output.phys_fields.plot(field=Mach, key_field='local Mach number', 
                            nb_contours=20)
